            ...
            <div class="col-8" style="padding-inline: 4.5rem;">
                ...
                <VForm v-slot="{ errors }" ref="form" @submit="OnSubmit">
                    <div class="form-floating mb-3">
                        <VField v-model="data.user.email" rules="required|email"
                        :class="{ 'is-invalid': errors['email'] }"
                        type="email" class="form-control"
                        id="floatingEmail" name="email" placeholder="請輸入email" />
                        <label for="floatingEmail" class="form-label">Email</label>
                        <ErrorMessage name="email" class="invalid-feedback" />
                    </div>
                    <div class="form-floating mb-3">
                        <VField v-model="data.user.name" rules="required"
                        :class="{ 'is-invalid': errors['姓名'] }"
                        type="text" class="form-control"
                        id="floatingName" name="姓名" placeholder="請輸入姓名" />
                    ...
                    <div class="form-floating mb-3">
                        <VField v-model="data.user.address" rules="required"
                        :class="{ 'is-invalid': errors['地址'] }"
                        type="text" class="form-control"
                        id="floatingAddress" name="地址" placeholder="請輸入地址" />
                    ...
                    <div class="mb-3">
                        ...
                        id="message" cols="30" rows="10" class="form-control"></textarea>
                    </div>
                    <div class="text-end">
