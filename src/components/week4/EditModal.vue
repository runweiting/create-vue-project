                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-4">
                                    ...
                                    <input v-model="tempProduct.imageUrl" type="url"
                                    class="form-control mb-2" id="imgUrl" placeholder="請輸入網址">
                                ...
                                <div v-if="Array.isArray(tempProduct.imagesUrl)" class="mb-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        -->
                                        <button v-if="tempProduct.imagesUrl.length === 0
                                        || tempProduct.imagesUrl[tempProduct.imagesUrl.length - 1]"
                                        @click="tempProduct.imagesUrl.push('')"
                                        type="button"
                                        class="btn btn-outline-primary w-100">新增圖片</button>
                                        <button @click="tempProduct.imagesUrl.pop()"
                                        type="button"
                                        class="btn btn-outline-danger w-100">刪除圖片</button>
                                    </div>
                                </div>
                                <!-- 上傳圖片 -->
                                <h4 class="fw-bold">上傳圖片</h4>
                                <div class="mb-4">
                                    <input @change="upload" class="form-control"
                                    type="file" id="formFile" placeholder="請輸入圖片連結">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <label for="title" class="form-label">標題</label>
                                <input v-model="tempProduct.title" type="text"
                                class="form-control mb-4" name="title" placeholder="請輸入標題">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="category" class="form-label">分類</label>
                                        <input v-model="tempProduct.category" type="text"
                                        class="form-control mb-4" id="category"
                                        placeholder="請輸入分類">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="unit" class="form-label">單位</label>
                                        <input v-model="tempProduct.unit" type="text"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input v-model.number="tempProduct.origin_price"
                                        type="number" min="0"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input v-model.number="tempProduct.price" type="number"
                                        min="0" class="form-control mb-4" id="price"
                                        placeholder="請輸入售價">
                                    </div>
                                </div>
                                <hr>
