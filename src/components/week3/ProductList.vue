...
<template>
  <div class="col mt-4 mb-4">
    <div class="container py-2">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="mb-4">
                      ...
                      <input v-model="tempData.imageUrl"
                      type="url" class="form-control mb-2" id="imgUrl" placeholder="請輸入網址">
                    ...
                    <div v-if="Array.isArray(tempData.imagesUrl)" class="mb-4">
                      <div v-for="(url, key) in tempData.imagesUrl" :key="key">
                        ...
                        <input :id="`url${key}`" v-model="tempData.imagesUrl[key]"
                        type="url" class="form-control mb-2"  placeholder="請輸入網址">
                      ...
                      <div class="d-flex gap-2">
                        ...
                        -->
                        <button
                        v-if="tempData.imagesUrl.length === 0
                        || tempData.imagesUrl[tempData.imagesUrl.length - 1]"
                        @click="tempData.imagesUrl.push('')"
                        type="button" class="btn btn-outline-primary w-100">新增圖片</button>
                        <button v-else @click="tempData.imagesUrl.pop()"
                        type="button" class="btn btn-outline-danger w-100">刪除圖片</button>
                      </div>
                    </div>
                    <div v-else>
                      <!-- // ? v-else 顯示新增圖片按鈕 -->
                  ...
                  <div class="col-md-8">
                    ...
                    <input v-model="tempData.title" type="text"
                    class="form-control mb-4" name="title" placeholder="請輸入標題">
                    <div class="row">
                      <div class="col-md-6">
                        <label for="category" class="form-label">分類</label>
                        <input v-model="tempData.category" type="text"
                        class="form-control mb-4" id="category" placeholder="請輸入分類">
                      </div>
                      <div class="col-md-6">
                        <label for="unit" class="form-label">單位</label>
                        <input v-model="tempData.unit" type="text"
                        class="form-control mb-4" id="unit" placeholder="請輸入單位">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <label for="original_price" class="form-label">原價</label>
                        <input v-model.number="tempData.origin_price"
                        type="number" min="0" class="form-control mb-4"
                        id="original_price" placeholder="請輸入原價">
                      </div>
                      <div class="col-md-6">
                        <label for="price" class="form-label">售價</label>
                        <input v-model.number="tempData.price" type="number" min="0"
                        class="form-control mb-4" id="price" placeholder="請輸入售價">
                      </div>
                    </div>
                    <hr>
                    <div>
                      <label for="textarea" class="form-label">商品描述</label>
                      <textarea v-model="tempData.description" class="form-control mb-4"
                      placeholder="請輸入商品描述" id="textarea"></textarea>
                    </div>
                    <div>
                      <label for="textarea" class="form-label">說明內容</label>
                      <textarea v-model="tempData.content" class="form-control mb-4"
                      placeholder="請輸入說明內容" id="textarea"></textarea>
                    </div>
                    <div class="form-check">
                      <input v-model="tempData.is_enabled" class="form-check-input"
      ...
      <!-- delModal -->
      <div class="modal fade modal-lg" id="delModal"
      tabindex="-1" aria-labelledby="delModalLabel" aria-hidden="true">
